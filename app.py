...
[data-testid="stChatMessage"] [data-testid="chatAvatarIcon-user"] {
    background: linear-gradient(135deg, #c8922a, #e8c97a) !important;
...
[data-testid="stChatMessage"] [data-testid="chatAvatarIcon-assistant"] {
    background: linear-gradient(135deg, #4a5c3a, #6b7c5c) !important;
    border-radius: 10px !important;
    color: #f5edd8 !important;
}
</style>
...
with st.sidebar:
    ...
    llm_provider = st.radio(
        "Select AI Model:",
        options=["Groq (Llama 3.3)", "Gemini (Flash 2.5)"],
        index=0,
...
def run_query(prompt):
    ...
    with st.chat_message("assistant"):
        ...
        if result["citations"]:
            ...
            st.caption("⚠️ No handbook excerpts found.")
